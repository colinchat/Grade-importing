...
marm_data.apply_late_penalty(0.2 * config["marm_total"], 0, 24)
marm_data.apply_late_penalty(0.4 * config["marm_total"], 24, 48)
marm_data.apply_late_penalty(config["marm_total"], 48)
...
crowd_data.apply_late_penalty(0.2 * config["crowd_total"], 0, 24)
crowd_data.apply_late_penalty(0.4 * config["crowd_total"], 24, 48)
crowd_data.apply_late_penalty(config["crowd_total"], 48)
